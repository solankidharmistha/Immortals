                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Column(children: [
                      ...
                      Autocomplete<int>(
                        optionsBuilder: (TextEditingValue value) {
                          if(value.text.isEmpty) {
                            ...
                            return _cuisines.where((cuisine) => authController.cuisineModel.cuisines[cuisine].name.toLowerCase().contains(value.text.toLowerCase()));
                          }
                        },
                      ...
                      SizedBox(height: authController.selectedCuisines.length > 0 ? Dimensions.PADDING_SIZE_SMALL : 0),
                      SizedBox(
                        height: authController.selectedCuisines.length > 0 ? 40 : 0,
                    ...
                    !authController.isLoading ? CustomButton(
                      ...
                      onPressed: () {
                        ...
                        if(_name.isEmpty) {
                          ...
                          authController.selectedCuisines.forEach((index) {
