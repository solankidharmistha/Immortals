                  ...
                  child: Padding(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      GetBuilder<RestaurantController>(builder: (restController) {
                        return restController.scheduleLoading ? Center(child: CircularProgressIndicator()) : Row(children: [
                ...
                child: Row(children: [
                  ...
                  InkWell(
                    onTap: () => Get.dialog(ConfirmationDialog(
                      ...
                      onYesPressed: () => Get.find<RestaurantController>().deleteSchedule(_scheduleList[index].id),
                    ), barrierDismissible: false),
