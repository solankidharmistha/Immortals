        ...
        return Column(children: [
          ...
          Expanded(child: SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              product.tags != null && product.tags.length > 0 ? Text('tags'.tr, style: robotoMedium) : SizedBox(),
              SizedBox(height: product.tags != null && product.tags.length > 0 ? Dimensions.PADDING_SIZE_EXTRA_SMALL : 0),

              product.tags != null && product.tags.length > 0 ? ListView.builder(
                itemCount: product.tags.length,
                physics: NeverScrollableScrollPhysics(),
                shrinkWrap: true,
                itemBuilder: (context, index) {
                  return Text(product.tags[index].tag, style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL));
                },
              ) : SizedBox(),
              SizedBox(height: product.tags != null && product.tags.length > 0 ? Dimensions.PADDING_SIZE_LARGE : 0),
