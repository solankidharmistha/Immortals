...
class MenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<MenuModel> _menuList = [
      ...
      MenuModel(icon: Images.coupon, title: 'coupon'.tr, backgroundColor: Color(0xFFFF8A80), route: RouteHelper.getCouponRoute()),
      ...
      MenuModel(icon: Images.expense, title: 'expense_report'.tr, backgroundColor: Color(0xFF62889C), route: RouteHelper.getExpenseRoute()),
