                ...
                return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  ListTile(
                    ...
                    leading: ClipOval(child: FadeInImage.assetNetwork(
                      placeholder: Images.notification_placeholder, height: 40, width: 40, fit: BoxFit.cover,
                      ...
                      imageErrorBuilder: (c, o, s) => Image.asset(Images.notification_placeholder, height: 40, width: 40, fit: BoxFit.cover),
                    )),
                    title: Text(
