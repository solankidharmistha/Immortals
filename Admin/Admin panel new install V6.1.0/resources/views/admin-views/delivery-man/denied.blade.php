...
@section('title', translate('messages.denied') . ' ' . translate('messages.deliverymen'))
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <h1 class="page-header-title text-capitalize">
                        ...
                        <span>
                            {{ translate('messages.denied') }} {{ translate('Deliveryman List') }}
                        </span>
                    </h1>
                </div>
            </div>
            ...
            <ul class="nav nav-tabs page-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active"
                        href="{{ route('admin.delivery-man.denied') }}">{{ translate('messages.denied') }} {{ translate('messages.deliveryman') }}</a>
                </li>
            </ul>
            <!-- End Nav -->
        </div>
